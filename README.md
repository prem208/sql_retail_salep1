...
1. **Set up a retail sale database**: Create and populate a retail sales database with the provided sales data.
...
- **Database Creation**: The project starts by creating a database named `sql_sale`.
